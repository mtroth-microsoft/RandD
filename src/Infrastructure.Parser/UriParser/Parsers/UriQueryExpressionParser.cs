...
namespace Infrastructure.Parser.UriParser
{
    ...
    using ODataErrorStrings = Strings;
        ...
        internal static string GetEdmConstantNames(IEdmTypeReference edmTypeReference)
        {
            ...
            switch (edmTypeReference.PrimitiveKind())
            {
                case EdmPrimitiveTypeKind.Boolean:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmBooleanTypeName;
                case EdmPrimitiveTypeKind.TimeOfDay:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmTimeOfDayTypeName;
                case EdmPrimitiveTypeKind.Date:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmDateTypeName;
                case EdmPrimitiveTypeKind.DateTimeOffset:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmDateTimeOffsetTypeName;
                case EdmPrimitiveTypeKind.Duration:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmDurationTypeName;
                case EdmPrimitiveTypeKind.Decimal:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmDecimalTypeName;
                case EdmPrimitiveTypeKind.String:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmStringTypeName;
                case EdmPrimitiveTypeKind.Int64:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmInt64TypeName;
                case EdmPrimitiveTypeKind.Int32:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmInt32TypeName;
                case EdmPrimitiveTypeKind.Double:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmDoubleTypeName;
                case EdmPrimitiveTypeKind.Single:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmSingleTypeName;
                case EdmPrimitiveTypeKind.Guid:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmGuidTypeName;
                case EdmPrimitiveTypeKind.Binary:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmBinaryTypeName;
                case EdmPrimitiveTypeKind.Geography:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmGeographyTypeName;
                case EdmPrimitiveTypeKind.Geometry:
                    return Infrastructure.Parser.Metadata.EdmConstants.EdmGeometryTypeName;
                default:
        ...
        private AggregationMethodDefinition ParseAggregateWith()
        {
            ...
            switch (methodLabel)
            {
                ...
                case ExpressionConstants.KeywordSum:
                    ...
                    break;
                default:
                    if (!methodLabel.Contains(ExpressionConstants.SymbolDot))
                    {
                        throw ParseError(
